...
**Узел** **ДОЛЖЕН**(MUST) отбрасывать RouteResponce **пакеты** если в них значение поля Destination совпадает с последними 128 битами значения поля Source прежде чем начнет какую либо их обработку.  
